...
<p>
   n<sub>ЛТ  </sub> = {N_лт} - количество листов текста <br>
   n<sub>Рис </sub> = {N_рис} - количество рисунков <br>
   n<sub>ЛТаб</sub> = {N_лтаб} - количество листов таблиц <br>
   n<sub>ЧС  </sub> = {N_чс} - количество чертежей (схем) <br>
   n<sub>Д   </sub> = {N_д} - количество документов <br>
