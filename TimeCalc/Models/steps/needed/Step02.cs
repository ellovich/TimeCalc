...
" + "\n";
        ...
        private static readonly Table s_T_2_2 = new Table(2.2, "Нормы на разработку текстовых документов по погрузке и упаковке изделия",
        ...
        private static readonly Table s_T_2_7 = new Table(2.7, "Затраты времени на разработку элементов программной документации",
